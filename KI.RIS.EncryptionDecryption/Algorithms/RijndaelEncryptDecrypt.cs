...
namespace KI.RIS.EncryptionDecryption.Algorithms
{
    ...
    public class RijndaelEncryptDecrypt
    {
        ...
        public static string RijndaelEncryptStringAES(string plainText, string sharedSecret)
        {
        ...
        public static string RijndaelDecryptStringAES(string cipherText, string sharedSecret)
        {
            RijndaelManaged aesAlg = null;
